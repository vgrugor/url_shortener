        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    @endif
                    <h2 class="text-center mt-5 text-4xl">All urls</h2>
                    <table class="border-collapse w-full m-2 border border-green-800 ...">
                        ...
                        @foreach($urls as $url)
                            <tr>
                                <td class="border">{{$url->user->name}}</td>
                                <td class="border">{{$url->user->email}}</td>
                                <td class="border">
                                    <a href="{{$url->url}}">
                                        {{ \Illuminate\Support\Str::limit($url->url, 50, $end='...') }}
                                    </a>
                                </td>
                                <td class="border">
